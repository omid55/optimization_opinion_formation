%Omid55
function [ population,fitnesses ] = CrossOver4SVM( population,fitnesses,Pc,dataTrain,labelsTrain,dataTest,labelsTest )
...
childrenFitnesses = zeros(size(children,1),1);
parfor i=1:size(children,1)
    childrenFitnesses(i) = CalculateFitness4SVM(children,dataTrain,labelsTrain,dataTest,labelsTest);
end
